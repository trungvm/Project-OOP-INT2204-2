                            ...
                            <form id="formSave" class="form-detail" action="editProject" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" onkeypress="return event.keyCode != 13;" class="form-control"
                                        name="projectName" value="<%= projectInfo.projectName %>" required />
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Descriptions</label>
                                    <textarea type="text" class="form-control" name="des" style="height: 80px"><%= projectInfo.description %></textarea>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Image</label>
                                    <textarea type="text" class="form-control" name="img"><%= projectInfo.img %></textarea>
                                </div>
