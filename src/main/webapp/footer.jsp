    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 pr-md-5">
                <a href="index.php" class="footer-site-logo d-block mb-4">FIO Team</a>
                <div class="col-md">
            ...
            <div class="col-md">
                <ul class="list-unstyled nav-links">
                    ...
                    <li><a href="https://mail.google.com/mail/u/0/?zx=o0cldfu4983m#inbox?compose=new">21020116@vnu.edu.vn</a>
                    </li>
                    <li><a href="https://mail.google.com/mail/u/0/?zx=o0cldfu4983m#inbox?compose=new">21020425@vnu.edu.vn</a>
                    </li>
                    <li><a href="https://mail.google.com/mail/u/0/?zx=o0cldfu4983m#inbox?compose=new">21020092@vnu.edu.vn</a>
                    </li>
                </ul>
            </div>
            <div class="col-md text-md-center">
                ...
                <p class=""><a href="https://www.facebook.com/" class="btn btn-tertiary">Contact Us</a></p>
            </div>
        </div>
