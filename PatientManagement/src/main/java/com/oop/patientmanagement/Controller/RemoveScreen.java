...
public class RemoveScreen {
    ...
    public void SearchInformationPatient() {
        ...
        if (!citizenID.isEmpty() && !string.equals("")) {
            ...
            textPatientName.setText("Tên bệnh nhân:   \t" + patientInfo.getName()); // hiển thị labal + data
    ...
    public void RemovePatient() {
        if (tf_searchByCitizenID.getText().isEmpty()) {
            ...
            Alert alert = new Alert(Alert.AlertType.CONFIRMATION); // CONFIRMATION - loại cửa sổ thông báo
